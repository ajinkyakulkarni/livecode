...
bool MCGroup::mfocus_control(int2 x, int2 y, bool p_check_selected)
{
    if (controls != nil)
    {
        ...
        do
        {
            ...
            {
                if (tptr.IsValid() && static_cast<MCGroup *>(tptr.Get()) -> mfocus_control(x, y, true))
                {
                    mfocused = tptr;
                    return true;
                }
            ...
            if (!p_check_selected && tptr == mfocused)
            {
                ...
                if (mfocused.IsValid() && (mfocused -> gettype() != CT_GROUP
                    || static_cast<MCGroup *>(mfocused.Get()) -> getmfocused() != nil))
                {
                    MCControl *oldfocused = mfocused;
                    mfocused = nullptr;
                    oldfocused->munfocus();
                ...
                {
                    static_cast<MCGroup *>(mfocused.Get()) -> clearmfocus();
                    mfocused = nil;
                }
            }
